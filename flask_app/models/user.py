...
class User:
    ...
    def add_address(cls, data):
        query = "INSERT INTO addresses (street1, street2, city, state, zipcode, country) VALUES (%(street1)s, %(street2)s, %(city)s, %(state)s,%(zipcode)s, %(country)s);"
        return connectToMySQL(SCHEMA).query_db(query, data)
